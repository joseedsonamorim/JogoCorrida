...
//Debug.Log("[" + Time.frameCount + "] Emulated finger OnTouchStart() LOOP detected!! (Zone: " + this.zone.name + ")"); 
			...
			int fingerNum =  
				(ControlFreak2.CF2Input.GetKey(this.zone.emuMouseTwoFingersKey) || ControlFreak2.CF2Input.GetKey(this.zone.emuMouseTwistKey) || (ControlFreak2.CF2Input.GetKey(this.zone.emuMousePinchKey)) ? 2 :
				ControlFreak2.CF2Input.GetKey(this.zone.emuMouseThreeFingersKey) ? 3 : 1);
		...
		public void Update()
			...
			if (this.mouseTouchObj != null)
				...
				bool twistMode = ControlFreak2.CF2Input.GetKey(this.zone.emuMouseTwistKey);
				bool pinchMode = ControlFreak2.CF2Input.GetKey(this.zone.emuMousePinchKey);

				if (this.zone.emuMousePinchAxis == this.zone.emuMouseTwistAxis)
					pinchMode = false;

				bool swipeMode = ControlFreak2.CF2Input.GetKey(this.zone.emuMouseTwoFingersKey) || ControlFreak2.CF2Input.GetKey(this.zone.emuMouseThreeFingersKey) || (!twistMode && !pinchMode);
			...
			/// ...or update keyboard...
				...
				Vector2 swipeSpeed = new Vector2(
					(ControlFreak2.CF2Input.GetKey(this.zone.emuKeySwipeR) ? 1 : 0) + (ControlFreak2.CF2Input.GetKey(this.zone.emuKeySwipeL) ? -1 : 0), 
					(ControlFreak2.CF2Input.GetKey(this.zone.emuKeySwipeU) ? 1 : 0) + (ControlFreak2.CF2Input.GetKey(this.zone.emuKeySwipeD) ? -1 : 0));
		
				float pinchSpeed = (ControlFreak2.CF2Input.GetKey(this.zone.emuKeyPinch) ? -1 : 0) + (ControlFreak2.CF2Input.GetKey(this.zone.emuKeySpread) ? 1 : 0);
				float twistSpeed = (ControlFreak2.CF2Input.GetKey(this.zone.emuKeyTwistL) ? -1 : 0) + (ControlFreak2.CF2Input.GetKey(this.zone.emuKeyTwistR) ? 1 : 0);
				...
				if (this.curFingerNum == 0)	
					...
					if ((swipeSpeed.sqrMagnitude > 0.0001f) || ControlFreak2.CF2Input.GetKey(this.zone.emuKeyOneFinger))
						fingerNum = 1;
					else if ((Mathf.Abs(pinchSpeed) > 0.0001f) || (Mathf.Abs(twistSpeed) > 0.001f) || ControlFreak2.CF2Input.GetKey(this.zone.emuKeyTwoFingers))
						fingerNum = 2;
					else if (ControlFreak2.CF2Input.GetKey(this.zone.emuKeyThreeFingers))
						fingerNum = 3;
					...
					if ((swipeSpeed.sqrMagnitude < 0.0001f) && (Mathf.Abs(pinchSpeed) < 0.0001f) && (Mathf.Abs(twistSpeed) < 0.001f) && 
						((this.curFingerNum == 1) ? !ControlFreak2.CF2Input.GetKey(this.zone.emuKeyOneFinger) :
						 (this.curFingerNum == 2) ? !ControlFreak2.CF2Input.GetKey(this.zone.emuKeyTwoFingers) :
						 (this.curFingerNum == 3) ? !ControlFreak2.CF2Input.GetKey(this.zone.emuKeyThreeFingers) : true))
						{
						this.EndTouches(false);		
						}
					else
