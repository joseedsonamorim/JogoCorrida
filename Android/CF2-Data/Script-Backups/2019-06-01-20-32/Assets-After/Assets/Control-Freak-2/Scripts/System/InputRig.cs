...
//! \endcond
	...
	public bool GetKey(KeyCode keyCode)
		...
		if (this.keysBlocked[(int)keyCode])
			return false;		
		return ((CF2Input.IsInMobileMode() && IsMouseKeyCode(keyCode)) ?  false : ControlFreak2.CF2Input.GetKey(keyCode));
		}
	...
	public bool GetKeyDown(KeyCode keyCode)
		...
		if (this.keysBlocked[i])
			return false;		
		return ((CF2Input.IsInMobileMode() && IsMouseKeyCode(keyCode)) ?  false : ControlFreak2.CF2Input.GetKeyDown(keyCode));
		}
	...
	public bool GetKeyUp(KeyCode keyCode)
		...
		if (this.keysBlocked[i])
			return false;		
		return ((CF2Input.IsInMobileMode() && IsMouseKeyCode(keyCode)) ?  false : ControlFreak2.CF2Input.GetKeyUp(keyCode));
		}
	...
	// ----------------------
	public bool AnyKey()		{ return (this.keysCurSomeOn || ControlFreak2.CF2Input.anyKey); }
	public bool AnyKeyDown()	{ return (this.keysCurSomeDown || ControlFreak2.CF2Input.anyKeyDown); }
...
//! \cond
	...
	// --------------------
	public struct ControlFreak2.InputRig.Touch
		{
		...
		static public ControlFreak2.InputRig.Touch Dummy;
		...
		// -------------------
		public Touch(ControlFreak2.InputRig.Touch t)
			{
			this.phase			= t.phase;
	...
	// ----------------
	public ControlFreak2.InputRig.Touch GetEmuTouch(int i)
		{	
	...
	private class EmulatedTouchState
		...
		public ControlFreak2.InputRig.Touch outputTouch;
		private bool isUsed;
