...
// ----------------
	...
	static public bool	fullScreen
		{
		get { return ControlFreak2.CFScreen.fullScreen; }
		set { UpdateDpi(); ControlFreak2.CFScreen.fullScreen = value; }
		}
	...
	static public void SetResolution(int width, int height, bool fullScreen, int refreshRate = 0)
		...
		ControlFreak2.CFScreen.SetResolution(width, height, fullScreen, refreshRate);
		}
	...
	static private void UpdateDpiIfNeeded()
		...
		if ((mLastScreenWidth != Screen.width) || (mLastScreenHeight != Screen.height) || (mLastScreenDpi != ControlFreak2.CFScreen.dpi) ||
	...
	static public void UpdateDpi()
		...
		if ((mLastScreenDpi != ControlFreak2.CFScreen.dpi) || (mNativeScreenResolution.width <= 0) || (mNativeScreenResolution.height <= 0))
			{
			mNativeScreenResolution = curResolution;
			mNativeScreenDpi = ControlFreak2.CFScreen.dpi;
			}

		mLastScreenWidth	= Screen.width;
		mLastScreenHeight	= Screen.height;
		mLastScreenDpi		= ControlFreak2.CFScreen.dpi;
