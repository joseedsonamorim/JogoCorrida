...
//! \endcond
	...
	static private CursorLockMode InternalGetLockMode()
		{
#if UNITY_PRE_5
		return (ControlFreak2.CFScreen.lockCursor ? CursorLockMode.Locked : CursorLockMode.None);
#else
		return ControlFreak2.CFCursor.lockState;
#endif
		}
	...
	static private void InternalSetLockMode(CursorLockMode mode)
		{
#if UNITY_PRE_5
		ControlFreak2.CFScreen.lockCursor = (mode == CursorLockMode.Locked);
#else
		ControlFreak2.CFCursor.lockState = mode;
#endif
		}
	...
	static private void InternalSetVisible(bool visible)
		{
#if UNITY_PRE_5
		ControlFreak2.CFScreen.showCursor = visible;
#else
		ControlFreak2.CFCursor.visible = visible;
#endif
		}
