...
//! \endcond
	...
	static public InputRig activeRig
		...
		set 
			...
			if (mRig != null)
				...
				mSimulateMouseWithTouches = ControlFreak2.CF2Input.simulateMouseWithTouches;
			...
			if (mRig != null)	
				...
				ControlFreak2.CF2Input.simulateMouseWithTouches = simulateMouseWithTouchesWhenRigIsActive;
				}
			else
				{
				ControlFreak2.CF2Input.simulateMouseWithTouches = mSimulateMouseWithTouches;
				}
...
#endif 
		return ((mRig != null) ? mRig.GetAxis(axisName)				: ControlFreak2.CF2Input.GetAxis(axisName)); 
		}
	...
	static public float GetAxis(string axisName, ref int cachedId)		
		...
		return ((mRig != null) ? mRig.GetAxis(axisName, ref cachedId)	: ControlFreak2.CF2Input.GetAxis(axisName)); 
		}
	...
	static public float GetAxisRaw(string axisName)
		...
		ControlFreak2Editor.Assistant.CaptureAxis(axisName);
#endif 
		return ((mRig != null) ? mRig.GetAxisRaw(axisName)			: ControlFreak2.CF2Input.GetAxisRaw(axisName)); 
		}
	...
	static public float GetAxisRaw(string axisName, ref int cachedId)	
		...
		ControlFreak2Editor.Assistant.CaptureAxis(axisName);
#endif 
		return ((mRig != null) ? mRig.GetAxisRaw(axisName, ref cachedId) : ControlFreak2.CF2Input.GetAxisRaw(axisName)); 
		}
...
#endif 
		return ((mRig != null) ? mRig.GetButton(axisName)					: ControlFreak2.CF2Input.GetButton(axisName)); 
		}
	...
	static public bool	GetButton(string axisName, ref int cachedId)
		...
		ControlFreak2Editor.Assistant.CaptureButton(axisName);
#endif 
		return ((mRig != null) ? mRig.GetButton(axisName, ref cachedId)	: ControlFreak2.CF2Input.GetButton(axisName)); 
		}
	...
	static public bool	GetButtonDown(string axisName)					
		...
		ControlFreak2Editor.Assistant.CaptureButton(axisName);
#endif 
		return ((mRig != null) ? mRig.GetButtonDown(axisName)				: ControlFreak2.CF2Input.GetButtonDown(axisName)); 
		}
	...
	static public bool	GetButtonDown(string axisName, ref int cachedId)
		...
		ControlFreak2Editor.Assistant.CaptureButton(axisName);
#endif 
		return ((mRig != null) ? mRig.GetButtonDown(axisName, ref cachedId): ControlFreak2.CF2Input.GetButtonDown(axisName)); 
		}
	...
	static public bool	GetButtonUp(string axisName)
		...
		ControlFreak2Editor.Assistant.CaptureButton(axisName);
#endif 
		return ((mRig != null) ? mRig.GetButtonUp(axisName)				: ControlFreak2.CF2Input.GetButtonUp(axisName));
		}
	...
	static public bool	GetButtonUp(string axisName, ref int cachedId)
		...
		ControlFreak2Editor.Assistant.CaptureButton(axisName);
#endif 
		return ((mRig != null) ? mRig.GetButtonUp(axisName, ref cachedId)	: ControlFreak2.CF2Input.GetButtonUp(axisName)); 
		}
...
#endif 
		return ((mRig != null) ? mRig.GetKey(keyCode)		: ControlFreak2.CF2Input.GetKey(keyCode));
		}
	...
	static public bool	GetKeyDown(KeyCode keyCode)
		...
		ControlFreak2Editor.Assistant.CaptureKey(keyCode);
#endif 
		return ((mRig != null) ? mRig.GetKeyDown(keyCode)	: ControlFreak2.CF2Input.GetKeyDown(keyCode));
		}
	...
	static public bool	GetKeyUp(KeyCode keyCode)
		...
		ControlFreak2Editor.Assistant.CaptureKey(keyCode);
#endif 
		return ((mRig != null) ? mRig.GetKeyUp(keyCode)	: ControlFreak2.CF2Input.GetKeyUp(keyCode));
		}
...
#endif 
		return ((mRig != null) ? mRig.GetKey(keyName)		: ControlFreak2.CF2Input.GetKey(keyName));
		}
	...
	static public bool	GetKeyDown(string keyName)
		...
		ControlFreak2Editor.Assistant.CaptureKey(InputRig.NameToKeyCode(keyName));
#endif 
		return ((mRig != null) ? mRig.GetKeyDown(keyName)	: ControlFreak2.CF2Input.GetKeyDown(keyName)); 
		}
	...
	static public bool	GetKeyUp(string keyName)
		...
		ControlFreak2Editor.Assistant.CaptureKey(InputRig.NameToKeyCode(keyName));
#endif 
		return ((mRig != null) ? mRig.GetKeyUp(keyName)	: ControlFreak2.CF2Input.GetKeyUp(keyName));
		}


	// --------------------------
	static public bool anyKey		{ get { return ((mRig != null) ? mRig.AnyKey() : ControlFreak2.CF2Input.anyKey); } }


	// --------------------------
	static public bool anyKeyDown	{ get { return ((mRig != null) ? mRig.AnyKeyDown() : ControlFreak2.CF2Input.anyKeyDown); } }
...
#endif 
			return ((mRig != null) ? mRig.GetEmuTouchCount()	: ControlFreak2.CF2Input.touchCount); 
			} 
		}
	...
	static public InputRig.Touch[] touches
		...
		get { 
			...
			ControlFreak2Editor.Assistant.CaptureTouch();
#endif 
			return ((mRig != null) ? mRig.GetEmuTouchArray()	: InputRig.Touch.TranslateUnityTouches(ControlFreak2.CF2Input.touches)); 
			}
		}
	...
	static public InputRig.Touch	GetTouch(int i)
		...
		ControlFreak2Editor.Assistant.CaptureTouch();
#endif 
		return ((mRig != null) ? mRig.GetEmuTouch(i) 			: (new InputRig.Touch(ControlFreak2.CF2Input.GetTouch(i)))); 
		}
...
#endif 
		return ((mRig != null) ? mRig.GetMouseButton(mouseButton)		: ControlFreak2.CF2Input.GetMouseButton(mouseButton));
		}
	...
	static public bool	GetMouseButtonDown(int mouseButton)
		...
		ControlFreak2Editor.Assistant.CaptureKey(InputRig.MouseButtonToKey(mouseButton));
#endif 
		return ((mRig != null) ? mRig.GetMouseButtonDown(mouseButton)	: ControlFreak2.CF2Input.GetMouseButtonDown(mouseButton)); 
		}
	...
	static public bool	GetMouseButtonUp(int mouseButton)
		...
		ControlFreak2Editor.Assistant.CaptureKey(InputRig.MouseButtonToKey(mouseButton));
#endif 
		return ((mRig != null) ? mRig.GetMouseButtonUp(mouseButton)	: ControlFreak2.CF2Input.GetMouseButtonUp(mouseButton));
		}
...
#endif 
			return ((mRig == null) ? ControlFreak2.CF2Input.mousePosition : mRig.mouseConfig.GetPosition()); 
			}
		}
...
#endif 
			return ((mRig == null) ? new Vector2(ControlFreak2.CF2Input.mouseScrollDelta.x, ControlFreak2.CF2Input.mouseScrollDelta.y) : mRig.scrollWheel.GetDelta()); 
			}
		}
	...
	static public bool simulateMouseWithTouches
		{
		get 
			{ return ((mRig == null) ? ControlFreak2.CF2Input.simulateMouseWithTouches : mSimulateMouseWithTouches); }
