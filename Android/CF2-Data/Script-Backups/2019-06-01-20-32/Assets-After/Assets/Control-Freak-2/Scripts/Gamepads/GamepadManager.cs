...
//! \cond
		...
		private class InternalKeyState
			...
			private void ReadHardwareState()
				{
				this.stateCur = ((this.key == KeyCode.None) ? false : ControlFreak2.CF2Input.GetKey(this.key));
				}
		...
		private class InternalAxisState
			...
			private void ReadHardwareState()
				{
				this.SetVal((string.IsNullOrEmpty(this.axisName) ? 0 : ControlFreak2.CF2Input.GetAxisRaw(this.axisName))); 
				}
